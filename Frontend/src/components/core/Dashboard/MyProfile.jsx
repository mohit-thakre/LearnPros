...
setLoading(true)
  ...
  return (
    <>
      ...
      <div className="categorysec flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-900 p-8 px-12">
        <div className="flex items-center gap-x-4">
          <img
 src={user && user?.image ? user?.image : avatar}            alt={`profile-${user?.firstName}`}
